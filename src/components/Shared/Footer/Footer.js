...
import "./Footer.css";
import footer_icon from "../../../images/Icon/hicon.png";
    ...
    <footer className="bg-black">
      <div className="container px-5 pb-2 pt-12 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4 text-black flex justify-center lg:block">
            <div>
              <img src={footer_icon} alt="" />
              <h2 className="font-bold tracking-widest text-2xl mb-3 flex justify-center text-white">
                OUR CAMPUS.
              </h2>
            </div>
          </div>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4 text-white">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-black bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-white hover:text-black">
                SEND
              </button>
            </div>
