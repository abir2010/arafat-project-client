    ...
    <div>
      <div>
        <p className="text-3xl font-bold my-5">
          MANAGE <span className="text-yellow-500">PRODUCTS</span> OF YOUR WEBSITE
        </p>
      </div>
      <div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      <th
                        scope="col"
                        className="px-6 py-3 text-left text-sm font-medium text-yellow-500 uppercase tracking-wider"
                      >
                        course name
                      </th>
                      <th
                      ...
                      <th
                        scope="col"
                        className="px-6 py-3 text-left text-sm font-medium text-yellow-500 uppercase tracking-wider text-center"
                      >
                        manage
                      </th>
