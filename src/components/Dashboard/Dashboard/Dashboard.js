    ...
    <div>
      ...
      <div className="lg:flex">
        <div
          className={
            count % 2 == 0
              ? "flex flex-col h-screen p-3 w-72 bg-yellow-400 text-gray-100 lg:block block"
              : "flex flex-col h-screen p-3 w-72 bg-yellow-400 text-gray-100 lg:block hidden"
          }
        >
          <div className="space-y-3">
            <div className="flex items-center justify-start">
              ...
              <Link to={`${url}`} className="text-2xl text-black ml-3 font-bold">
                Dashboard
              </Link>
            </div>
                  ...
                  <>
                    <li className="rounded-md hover:bg-red-500">
                      ...
                      >
                        ...
                        <span className="text-black">Manage All Orders</span>
                      </Link>
                    </li>
                    <li className="rounded-md hover:bg-red-500">
                      <Link
