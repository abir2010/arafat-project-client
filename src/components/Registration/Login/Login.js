...
import cycle from "../../../images/servicing/login.jpg";
...
const Login = () => {
  ...
  return (
    <div>
      <Header />
      <section
        className="text-gray-100 bg-yellow-400 body-font"
        data-aos="fade-down"
        data-aos-delay="50"
      ...
      >
        <div className="container lg:px-5 mt-4 mx-auto flex flex-wrap items-center">
          ...
          <div className="lg:w-2/6 md:w-1/2 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            <h2 className="text-black text-xl font-bold font-medium title-font mb-5">
              Log In
            </h2>
            ...
            <button
              ...
              className="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-black hover:text-white text-lg"
            >
              LOGIN
            </button>
            <div>
              <h2 className="text-xs text-black tracking-widest font-bold title-font mt-2">
                Need to create account?{" "}
                <Link className="text-red-900 border px-1 bg-white text-sm" to="/register">
                  Register Here
                </Link>
              </h2>
            </div>
