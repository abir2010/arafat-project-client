    ...
    <div>
      ...
      <div className="lg:flex justify-center gap-20">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-lg">
          ...
          <button
            type="submit"
            className="inline-flex text-gray-50 items-center bg-red-500 border-0 py-2 mb-12 px-8 focus:outline-none hover:bg-yellow-400 mt-4 md:mt-0 lg:ml-4"
          >
            SEND ORDER NOW
          </button>
        </form>
